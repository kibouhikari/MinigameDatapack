...
execute as @a[team=rmn.blue,tag=rmn.player] at @s run scoreboard players add @e[type=marker,tag=rmn.map1,tag=rmn.tdm_random_spawn,limit=1,sort=furthest] rmn.random_spawn 1
...
execute as @e[type=marker,tag=rmn.map1,tag=rmn.tdm_random_spawn] if score @s rmn.random_spawn >= #blue_player rmn.temporary run tag @s add rmn.can_spawn_red
tag @e[type=marker,tag=rmn.map1,tag=rmn.can_spawn_red,limit=1,sort=random] add rmn.red
tag @e[type=marker,tag=rmn.map1,tag=rmn.can_spawn_red] remove rmn.can_spawn_red
