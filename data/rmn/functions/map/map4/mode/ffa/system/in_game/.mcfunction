# 死亡処理
    ...
    execute as @r[tag=rmn.death] run function rmn:map/map4/mode/ffa/system/death/
...
# 試合時間が0なら試合を終了させる
    execute if score #ffa_gametimer rmn.temporary matches ..0 run function rmn:map/map4/mode/ffa/gameend/