# 死亡処理
    ...
    execute as @r[tag=rmn.death] run function rmn:map/map6/mode/br/system/death/
...
# 補給ボックス
    execute if score #br_supplybox rmn.temporary matches ..0 run function rmn:map/map6/mode/br/system/supply/
...
# フェーズ変更
    execute if score #br_phase rmn.temporary matches 0 if score #br_gametimer_0 rmn.temporary matches ..0 run function rmn:map/map6/mode/br/system/phase/change
    execute if score #br_phase rmn.temporary matches 1 if score #br_gametimer_1 rmn.temporary matches ..0 run function rmn:map/map6/mode/br/system/phase/change
    execute if score #br_phase rmn.temporary matches 2 if score #br_gametimer_2 rmn.temporary matches ..0 run function rmn:map/map6/mode/br/system/phase/change
    execute if score #br_phase rmn.temporary matches 3 if score #br_gametimer_3 rmn.temporary matches ..0 run function rmn:map/map6/mode/br/system/phase/change
...
# 生存者が一人以下なら試合を終了させる
    ...
    execute if score #player_alive rmn.temporary matches ..1 run function rmn:map/map6/mode/br/gameend/