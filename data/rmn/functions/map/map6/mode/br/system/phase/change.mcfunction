...
# フェーズ2ならフェーズ3へ変更
    execute if score #br_phase rmn.temporary matches 2 in minecraft:tenkuu run worldborder set 21 90
...
# フェーズ1ならフェーズ2へ変更
    execute if score #br_phase rmn.temporary matches 1 in minecraft:tenkuu run worldborder set 501 150
    ...
    execute if score #br_phase rmn.temporary matches 1 store result bossbar minecraft:rmn.br_gametimer_1 max run scoreboard players get #br_gametimer_2 rmn.temporary
...
# フェーズ0ならフェーズ1へ変更
    ...
    execute if score #br_phase rmn.temporary matches 0 in minecraft:tenkuu run worldborder set 1001 360
