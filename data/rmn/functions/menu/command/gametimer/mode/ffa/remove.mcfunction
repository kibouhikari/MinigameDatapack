execute if score #ffa_gametimer rmn.temporary matches 30.. run playsound ui.button.click player @s ~ ~ ~ 1
execute unless score #ffa_gametimer rmn.temporary matches 30.. run playsound block.note_block.bass player @s ~ ~ ~ 1
