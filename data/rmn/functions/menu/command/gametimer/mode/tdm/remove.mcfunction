execute if score #tdm_gametimer rmn.temporary matches 30.. run playsound ui.button.click master @s ~ ~ ~ 1
execute unless score #tdm_gametimer rmn.temporary matches 30.. run playsound block.note_block.bass master @s ~ ~ ~ 1
