execute if score #map rmn.temporary matches 1.. run playsound ui.button.click player @s ~ ~ ~ 1
execute unless score #map rmn.temporary matches 1.. run playsound block.note_block.bass player @s ~ ~ ~ 1
