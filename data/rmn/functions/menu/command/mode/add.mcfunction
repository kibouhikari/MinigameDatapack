execute if score #mode rmn.temporary matches ..0 run playsound ui.button.click master @s ~ ~ ~ 1
execute unless score #mode rmn.temporary matches ..0 run playsound block.note_block.bass master @s ~ ~ ~ 1
